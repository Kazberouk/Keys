...
#include "Interfaces/DLL_INC/CX_DLL_INC.h"
...
CLGProMain *CLGProMain::g_pProMain = nullptr;
CLGProMain *CLGProMain::GetProMain()
{
	if (!g_pProMain)
		g_pProMain = new CLGProMain;
	g_pProMain->AddRef();
	return g_pProMain;
}
...
{
	return CLGProMain::GetProMain();
}

CLGProMain::CLGProMain()
{
}
...
ULONG CLGProMain::GetInterfacesCount()
{
	long nICount = 0;
...
void CLGProMain::LoadInterfacesMap()
{
...
HRESULT CLGProMain::get_interface(const IID& ID, void** pI, int OwnerType, DWORD dwThis, IProperties* pIPROParameters)
{
	PRO_MANAGE_STATE;
